  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h2 style="font-size:25px; font-weight:800;  color: rgb(1, 65, 69);" class="modal-title" id="exampleModalLabel">Registar Funcionarios</h2>
        <button type="" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form class="form-not" action="{{route('user.store')}}" method="POST">
          @csrf
          <label  for="">Nome </label>
          <input type="text" placeholder="Informe o nome do funcionario nome" name="name" required>
          <label  for="">Email</label>
          <input type="email"  name="email" placeholder="Informe o correio electronico" required>
             ...
             <div class="div-noticias">
              <div class="notic-header">
                 <div class="noti-titulo">
                  <h1 style="font-size:25px">Funcionarios</h1>
                 </div>
                 <div class="pesquisar">
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color: red; color: white;">
                                    <h5 class="modal-title" id="exampleModalLabel">Apagar Funcionario</h5>
                                    <button type="" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body" style="background-color:black; color:white">
                                    <form class="form-not" action="{{route('user.destroy',$lista->id)}}" method="DELETE">

                                         <h1>DESEJA APAGAR O {{$lista->name}}?</h1>
